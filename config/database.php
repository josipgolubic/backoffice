...
*/
		'mysql' => [
			...
			'database'  => env('DB_DATABASE', env('OPENSHIFT_APP_NAME', 'backoffice')),
			'username'  => env('DB_USERNAME', env('OPENSHIFT_MYSQL_DB_USERNAME', 'admin8dIEpwD')),
			'password'  => env('DB_PASSWORD', env('OPENSHIFT_MYSQL_DB_PASSWORD', 'EnYbTV4pYT8U')),
			'charset'   => 'utf8',
